...
#
#     def forward(self, x):
#         res_net_out = self.net.res_net(x)
#
#         fc1_out = self.net.fc1(res_net_out)
#         fc2_out = self.net.fc2(fc1_out)
#
#         resize_out = self.net.fc_resize(fc2_out)
#         resize_out = self.net.sig_resize(resize_out)
#
...
#         self.net = nn.ModuleDict({
#             "res_net": self.__res_net,
#             "fc_resize": nn.Linear(self.__res_net.fc.out_features, 2),
#             "sig_resize": nn.Sigmoid(),
#             "fc_translate": nn.Linear(self.__res_net.fc.out_features, 2),
#             "tanh_translate": nn.Tanh()
#         })
#
#     def forward(self, x):
#         res_net_out = self.net.res_net(x)
#
#         resize_out = self.net.fc_resize(res_net_out)
#         resize_out = self.net.sig_resize(resize_out)
#
#         translate_out = self.net.fc_translate(res_net_out)
#         translate_out = self.net.tanh_translate(translate_out)
#
#         x = torch.cat((resize_out, translate_out), 1)
#
